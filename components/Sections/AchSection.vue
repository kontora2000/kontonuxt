    ...
    <section class="achievements-cont">
        <div class="section-inner">
            ...
            <div class="achiev-about-wrapper">
                <h4 class="achiev-about-item">Специализируемся на сложных системах публикации и&nbsp;системах управления онлайн-коммерцией</h4>
...
.achiev-item:nth-child(2) .achiev-digit:after {
    content: '+';
    font-weight: 260;
