  ...
  <main>
    <section class="page-cont-vacancies page-cont">
      <div class="section-inner">
        ...
        <h1 class="page-section-header">1 вакансия<sup class="page-section-header-sup section-header-sup">Работаем&nbsp;удалённо, помогаем и&nbsp;обучаем, <br class="only-desktop">ценим&nbsp;результат</sup></h1>

        <div class="vacancies-wrapper">
          <div class="vacancy-cont">
              <h4>Педантичный фронтендер</h4>
